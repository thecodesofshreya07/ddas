...
class LocalDatabase {
  ...
  initSeedData() {
    ...
    const ds1 = {
      id: "ds-001",
      title: "Mumbai Daily Rainfall 2024",
      description: "Historical precipitation dataset for Mumbai metropolitan area recorded across 12 AWS stations.",
      domain: "Meteorology",
    ...
    const ds2 = {
      id: "ds-002",
      title: "Maharashtra Crop Yield & Soil Moisture Index",
      description: "Quarterly agricultural output and satellite-derived vegetation indices across 36 districts.",
      domain: "Agriculture",
      owner_department: "Agriculture",
    ...
    const ds3 = {
      id: "ds-003",
      title: "Delhi NCR Air Quality Monitoring Grid",
      description: "Hourly PM2.5, PM10, and NO2 concentration metrics from 40 central continuous monitoring stations.",
      domain: "Meteorology",
      owner_department: "Meteorology",
      classification: "public",
      status: "active",
    ...
    const dv1 = {
      ...
      dataset_id: "ds-001",
      version_num: 1,
      original_filename: "Mumbai_Rainfall_2024.csv",
      format: "csv",
      size_bytes: 14520,
      sha256: "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855",
      storage_key: "demo-rainfall-2024.csv",
      period_start: "2024-01-01",
      period_end: "2024-12-31",
      spatial_min_lat: 18.9,
      spatial_max_lat: 19.3,
      spatial_min_lng: 72.7,
      spatial_max_lng: 73.0,
      spatial_region_name: "Mumbai Metropolitan Region",
      schema_fingerprint: {
        columns: ["date", "station_id", "rainfall_mm", "temperature_c"],
        rowCount: 366,
      },
    ...
    const dv2 = {
      ...
      dataset_id: "ds-002",
      version_num: 1,
      original_filename: "MH_Agriculture_Soil_2024.csv",
      format: "csv",
      size_bytes: 28400,
      sha256: "a1b2c3d4e5f60123456789abcdef0123456789abcdef0123456789abcdef0123",
      storage_key: "demo-agri-2024.csv",
      period_start: "2024-01-01",
      period_end: "2024-09-30",
      spatial_min_lat: 15.6,
      spatial_max_lat: 22.0,
      spatial_min_lng: 72.6,
      spatial_max_lng: 80.9,
      spatial_region_name: "Maharashtra State",
      schema_fingerprint: {
        columns: ["district", "crop_type", "yield_tonnes", "soil_moisture_pct"],
        rowCount: 144,
      },
    ...
    const dv3 = {
      ...
      dataset_id: "ds-003",
      version_num: 1,
      original_filename: "Delhi_AQI_Continuous_2024.csv",
      format: "csv",
      size_bytes: 52100,
      sha256: "b2c3d4e5f6a10123456789abcdef0123456789abcdef0123456789abcdef0124",
      storage_key: "demo-aqi-2024.csv",
      period_start: "2024-01-01",
      period_end: "2024-06-30",
      spatial_min_lat: 28.4,
      spatial_max_lat: 28.9,
      spatial_min_lng: 76.8,
      spatial_max_lng: 77.4,
      spatial_region_name: "National Capital Region (Delhi)",
      schema_fingerprint: {
        columns: ["timestamp", "station_name", "pm25", "pm10", "no2"],
        rowCount: 4320,
      },
      uploaded_by: "u-rahul-002",
    ...
    // Initial alert/relationship
    this.version_relationships.push({
      id: "vr-demo-001",
      version_a_id: "dv-001",
      version_b_id: "dv-003",
      relationship_type: "near_duplicate",
      similarity_score: "89.4",
      score_breakdown: { content: 88, schema: 95, metadata: 85 },
      content_diff: { modifiedRows: 8, addedRows: 2, removedRows: 0 },
      created_at: new Date(Date.now() - 86400000 * 2).toISOString(),
    });

    this.alert_reviews.push({
      id: "ar-demo-001",
      relationship_id: "vr-demo-001",
      status: "new",
      assigned_to: "u-admin-001",
      notes: "Auto-flagged during weekly batch deduplication run.",
